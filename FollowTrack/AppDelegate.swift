...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UINavigationBar.appearance().backgroundColor = UIColor(hex: "73D0F4")
        UINavigationBar.appearance().barTintColor = UIColor(hex: "73D0F4")
    ...
    // MARK: - Core Data stack (pre ios10)
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "FollowTrack", withExtension: "momd")!
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "FollowTrack")
